...
const categories = [
  {
    ...
    subcategories: [
      {
        name: 'Smartphones',
        items: ['Apple iPhone 13 Pro Max', 'Samsung Galaxy Z Fold 3', 'Google Pixel 6 Pro']
      },
      {
        name: 'Laptops',
        items: ['Apple MacBook Pro (various models)', 'Dell XPS series', 'HP Spectre series']
      },
      {
        name: 'Audio-Visual Equipment',
        items: ['Sony Bravia OLED TVs', 'Bose home theater systems', 'Bang & Olufsen speakers']
      },
      {
        name: 'Smart Home Appliances',
        items: ['Dyson Air Purifiers', 'Nest Hub Max', 'Philips Hue smart lighting systems']
      }
    ]
  },
  {
    ...
    subcategories: [
      {
        ...
        items: ['Roche Bobois Mah Jong Sofa', 'Eames Lounge Chair and Ottoman', 'B&B Italia Harry Sofa']
      },
      {
        name: 'Beds and Mattresses',
        items: ['Hastens Vividus Bed', 'Tempur-Pedic mattresses', 'Savoir Beds']
      },
      {
        name: 'Dining Sets',
        items: ['Minotti Dining Table and Chairs', 'Baccarat Crystal Glassware', 'Christofle Flatware']
      },
      {
...
{
  name: 'Luxury Cars',
  items: ['Rolls-Royce Phantom', 'Ferrari 812 Superfast', 'Bentley Continental GT']
},
{
  name: 'Sports Cars',
  items: ['Porsche 911 Turbo S', 'Lamborghini Huracán EVO', 'McLaren 720S']
}
]
},
{
...
subcategories: [
{
  ...
  items: ['Gucci and Prada clothing lines', 'Christian Louboutin footwear', 'Hermès Birkin and Kelly bags']
},
{
  name: 'Luxury Watches and Jewelry',
  items: ['Rolex, Patek Philippe, and Audemars Piguet timepieces', 'Cartier and Tiffany & Co. jewelry']
}
]
},
{
...
subcategories: [
{
  ...
  items: ['Oculus Rift S', 'HTC Vive Pro', 'Valve Index']
},
{
  name: 'Augmented Reality Devices',
  items: ['Microsoft HoloLens 2', 'Magic Leap One', 'Vuzix Blade Smart Glasses']
}
]
},
{
